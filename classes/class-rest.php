 ...
 * Class Rest
 *
 * Handles Firebase Authentication REST functionalities.
 */
class Rest {
	...
	public function setup_hooks() {
		...
		add_action( 'rest_api_init', array( $this, 'firebase_auth_register_rest_route' ) );
	}
	 ...
	 * @return void
	 */
	public function firebase_auth_register_rest_route() {
		...
		register_rest_route(
			...
			array(
				'methods'             => 'POST',
				'callback'            => array( $this, 'firebase_auth_verify_token' ),
	 ...
	 */
	public function firebase_auth_verify_token( \WP_REST_Request $request ) {
